...
/*
  //
  // after test, Checkpoint 2 is a bug. And this bug will hinder the execution
  // of other test cases. so comments it out until it is fixed.
  //
...
/*
  // NULL DeviceHandle cause ASSERT

  //
  // Checkpoint 3:
  // 3.11.2.3   LocateDevicePath should not succeed with NULL device handle
  //
  DevicePath3 = DevicePath1;
  Status = gtBS->LocateDevicePath (
                   &mTestProtocol1Guid,
