...
#include "SimpleTextOutBBTestMain.h"
...
EFI_BB_TEST_PROTOCOL_FIELD gBBTestProtocolField = {
  ...
  L"EFI1.10 Simple Text Output Protocol Test"
};
  ...
  )
{
  ...
  Status = gtBS->AllocatePool (
                   EfiBootServicesData,
                   sizeof (EFI_UGA_PIXEL) * HorizontalResolution * GLYPH_WIDTH * GLYPH_HEIGHT,
                   &LineBuffer
                   );
